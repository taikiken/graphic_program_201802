...
if($q->get_dir()==1){
	...
	$a=array("公開","is_public",array("公開","非公開"),"");
...
<input type="radio" class="box" name="p_<?=$FIELD?>" value="<?=$I+1?>" id="<?=$FIELD?><?=$I?>"<?php if(($I+1)==$public)echo " checked"; ?> /><label for="<?=$FIELD?><?=$I?>"><?=$ARRAY[$I]?></label>
<?php } ?>
</td>
</tr>
</table>
