...
function set_category($category,$type){
	...
	return $category=="all"?" and m1!=152 and d2!=61":sprintf(" and (m1=%s or m2=%s)",$caa[$category],$caa[$category]);
...
function set_category2($category,$type){
	...
	return array($f["id"],$category=="all"?" and m1!=152 and d2!=61":sprintf(" and (m1=%s or m2=%s)",$f["id"],$f["id"]));
}
