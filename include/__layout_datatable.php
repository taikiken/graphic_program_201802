...
<?php } ?>
  <?php if ($CURRENTDIRECTORY != "company_news" && $CURRENTDIRECTORY != "notice" && $CURRENTDIRECTORY != "pickup_athlete_big4" && $CURRENTDIRECTORY != "bottom_tabs_category" && $CURRENTDIRECTORY != "bottom_tabs_nodes") { ?>
