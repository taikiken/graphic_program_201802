...
$ob=array(array("","　並び指定順　"),array("sold","　公開日新しい順　"),array("snew","　公開日古い順　"));
...
$sql="select id,(select name from repo where id=repo_n.cid) as name,title from repo_n where qid=2 and cid in(3,4,5) order by cid,n";
$o->query($sql);
