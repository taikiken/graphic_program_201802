...
function make_contentsblock($type,$title,$media,$link){
	...
	if($type==0){
		...
		$l=sprintf("<div class=\"cms_widget\"><div class=\"ratio16_9\"><div class=\"ratio16_9-inner\"><iframe width=\"728\" height=\"410\" src=\"//www.youtube.com/embed/%s?rel=0&showinfo=0\" frameborder=\"0\" allowfullscreen></iframe></div></div>%s</div>",$media,(strlen($title)>0)?sprintf("<div class=\"caption\"><span>%s</span></div>",$title):"");
	}elseif($type==4){
