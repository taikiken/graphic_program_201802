...
function make_contentsblock($type,$title,$media,$link){
	...
	if($type==0){
		...
		$l=sprintf("<div class=\"cms_video\"><div class=\"youtube\"><iframe width=\"640\" height=\"375\" src=\"http://www.youtube.com/embed/%s?feature=oembed\" frameborder=\"0\" allowfullscreen></iframe></div>%s</div>",$media,(strlen($title)>0)?sprintf("<div class=\"caption\"><span>%s</span></div>",$title):"");
	}elseif($type==4){
