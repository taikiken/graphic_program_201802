    ...
    return function b(a, c, d) {
        ...
        68: [function(a, b, c) {
            ...
            var g = a("../component.js"),
                ...
                y = (d(x), a("./spacer-controls/custom-control-spacer.js")),
                z = (d(y), function(a) {
                    function b() {
            ...
            }, h["default"].registerComponent("ControlBar", z), c["default"] = z, b.exports = c["default"]
        }, {
            "../component.js": 67,
        ...
        119: [function(a, b, c) {
            ...
            E.kind = "captions", E.srclang = "en", E.label = "English", D.TEST_VID.appendChild(E), D.isSupported = function() {
                ...
                if (u.IS_ANDROID && u.IS_CHROME) return !1;
                ...
                E = function(a) {
                    function b() {
                        ...
                        var g = q.TextTrackMode[c.mode] || "disabled",
                            ...
                            j = c["default"],
                            l = c.label || "",
                            n = c.language || c.srclang || "",
                            p = c.id || "vjs_text_track_" + m.newGUID();
                        ("metadata" === h || "chapters" === h) && (g = "hidden"), d.cues_ = [], d.activeCues_ = [];
                        var r = new i["default"](d.cues_),
                            s = new i["default"](d.activeCues_),
                            t = !1,
                            u = k.bind(d, function() {
                                this.activeCues, t && (this.trigger("cuechange"), t = !1)
                            });
                        return "disabled" !== g && d.tech_.on("timeupdate", u), Object.defineProperty(d, "kind", {
                            get: function() {
                                return h
                            },
                            set: function() {}
                            ...
                            set: function(a) {
                                q.TextTrackMode[a] && (g = a, "showing" === g && this.tech_.on("timeupdate", u), this.trigger("modechange"))
                            }
                            ...
                            get: function() {
                                ...
                                if (t = !1, b.length !== this.activeCues_.length) t = !0;
                                else
                                    for (var c = 0; c < b.length; c++) - 1 === this.activeCues_.indexOf(b[c]) && (t = !0);
                                return this.activeCues_ = b, s.setCues_(this.activeCues_), s
                            },
                            set: function() {}
        ...
        145: [function(b, c, d) {
            ...
            d.__esModule = !0; {
                var g = b("global/window"),
                    h = f(g),
                    i = b("global/document"),
                    j = f(i),
                    k = b("./setup"),
                    l = e(k),
                    m = b("./utils/stylesheet.js"),
                    n = e(m),
                    o = b("./component"),
                    p = f(o),
                    q = b("./event-target"),
                    ...
                    w = b("./plugins.js"),
                    x = f(w),
                    y = b("../../src/js/utils/merge-options.js"),
                    z = f(y),
                    A = b("./utils/fn.js"),
                    B = e(A),
                    C = b("./tracks/text-track.js"),
                    D = f(C),
                    E = b("object.assign"),
                    F = (f(E), b("./utils/time-ranges.js")),
                    G = b("./utils/format-time.js"),
                    H = f(G),
                    I = b("./utils/log.js"),
                    J = f(I),
                    K = b("./utils/dom.js"),
                    L = e(K),
                    M = b("./utils/browser.js"),
                    N = e(M),
                    O = b("./utils/url.js"),
                    P = e(O),
                    Q = b("./extend.js"),
                    R = f(Q),
                    S = b("lodash-compat/object/merge"),
                    T = f(S),
                    U = b("./utils/create-deprecation-proxy.js"),
                    V = f(U),
                    W = b("xhr"),
                    X = f(W),
                    Y = b("./tech/tech.js"),
            ...
            "undefined" == typeof HTMLVideoElement && (j["default"].createElement("video"), j["default"].createElement("audio"), j["default"].createElement("track"));
            var aa = function da(a, b, c) {
                var d = void 0;
                if ("string" == typeof a) {
                    if (0 === a.indexOf("#") && (a = a.slice(1)), da.getPlayers()[a]) return b && J["default"].warn('Player "' + a + '" is already initialised. Options will not be applied.'), c && da.getPlayers()[a].ready(c), da.getPlayers()[a];
                    d = L.getEl(a)
                } else d = a;
                if (!d || !d.nodeName) throw new TypeError("The element or ID supplied is not valid. (videojs)");
                return d.player || v["default"].players[d.playerId] || new v["default"](d, b, c)
            };
            if (h["default"].VIDEOJS_NO_DYNAMIC_STYLE !== !0) {
                var ba = L.$(".vjs-styles-defaults");
                if (!ba) {
                    ba = n.createStyleElement("vjs-styles-defaults");
                    var ca = L.$("head");
                    ca.insertBefore(ba, ca.firstChild), n.setTextContent(ba, "\n      .video-js {\n        width: 300px;\n        height: 150px;\n      }\n\n      .vjs-fluid {\n        padding-top: 56.25%\n      }\n    ")
                }
            }
            l.autoSetupTimeout(1, aa), aa.VERSION = "5.9.2", aa.options = v["default"].prototype.options_, aa.getPlayers = function() {
                return v["default"].players
            }, aa.players = V["default"](v["default"].players, {
                get: "Access to videojs.players is deprecated; use videojs.getPlayers instead",
                set: "Modification of videojs.players is deprecated"
            }), aa.getComponent = p["default"].getComponent, aa.registerComponent = function(a, b) {
                Z["default"].isTech(b) && J["default"].warn("The " + a + " tech was registered as a component. It should instead be registered using videojs.registerTech(name, tech)"), p["default"].registerComponent.call(p["default"], a, b)
            }, aa.getTech = Z["default"].getTech, aa.registerTech = Z["default"].registerTech, aa.browser = N, aa.TOUCH_ENABLED = N.TOUCH_ENABLED, aa.extend = R["default"], aa.mergeOptions = z["default"], aa.bind = B.bind, aa.plugin = x["default"], aa.addLanguage = function(a, b) {
                var c;
                return a = ("" + a).toLowerCase(), T["default"](aa.options.languages, (c = {}, c[a] = b, c))[a]
            }, aa.log = J["default"], aa.createTimeRange = aa.createTimeRanges = F.createTimeRanges, aa.formatTime = H["default"], aa.parseUrl = P.parseUrl, aa.isCrossOrigin = P.isCrossOrigin, aa.EventTarget = r["default"], aa.on = t.on, aa.one = t.one, aa.off = t.off, aa.trigger = t.trigger, aa.xhr = X["default"], aa.TextTrack = D["default"], aa.isEl = L.isEl, aa.isTextNode = L.isTextNode, aa.createEl = L.createEl, aa.hasClass = L.hasElClass, aa.addClass = L.addElClass, aa.removeClass = L.removeElClass, aa.toggleClass = L.toggleElClass, aa.setAttributes = L.setElAttributes, aa.getAttributes = L.getElAttributes, aa.emptyEl = L.emptyEl, aa.appendContent = L.appendContent, aa.insertContent = L.insertContent, "function" == typeof a && a.amd ? a("videojs", [], function() {
                return aa
            }) : "object" == typeof d && "object" == typeof c && (c.exports = aa), d["default"] = aa, c.exports = d["default"]
        }, {
...
function(a) {
    ...
    function l(a) {
        ...
        this.left = a.left, this.right = a.right, this.top = a.top || e, this.height = a.height || c, this.bottom = a.bottom || e + (a.height || c), this.width = a.width || d, this.lineHeight = void 0 !== b ? b : a.lineHeight,
