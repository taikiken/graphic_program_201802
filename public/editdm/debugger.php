...
$api=array(
	...
	array("/api/v1/sessions/social","[-] ソーシャルログイン",30,"POST"),
	array("/api/v1/category","[-] カテゴリー一覧",1,"GET"),
	array("/api/v1/category","[-] 記事カテゴリー情報",31,"GET"),
	...
	array("/api/v1/articles","[C] 記事詳細 次の[N]件",32,"GET"),
	...
	array("/api/v1/users/self/bookmark","[M] ブックマークした記事一覧",15,"GET"),
	...
	array("/api/v1/users/self/settings/interest","[M] 興味のある競技更新",18,"POST"),
	...
	array("/api/v1/users/email","[-] 新規ユーザ登録（メールチェック）",29,"POST"),
	array("/api/v1/users/","[-] 新規ユーザ登録",24,"POST"),
	array("/api/v1/users/","[-] 退会",27,"DELETE")
);

$api2[]=array("all","すべて（all）");
$sql="select id,name,name_e from u_categories order by n";
$o->query($sql);
...
$sql="select id,title from repo_n where flag=1 order by id desc limit 1000 offset 0";
$o->query($sql);
while($f=$o->fetch_array()){
	$article[]=$f;
}

$sql="select id,title,a15 from u_member where qid=2 and cid!=3 and flag=1 order by title";
$o->query($sql);
while($f=$o->fetch_array()){
	$user[]=$f;
}
...
<table>
<tr class="thead"><th class="c1">項目名</th><td class="c2"><b>必須</b></td><td class="c3"><b>値</b></td></tr>
<tr><th>タイプ</th><td class="c2">-</td><td class="c3"><input type="text" value="" class="vv type in" placeholder="type" style="width:200px"><span class="spl">(String)　[(空：新着順) | pickup | headline | personalized]</span></td></tr>
<tr><th>オフセット</th><td class="c2">-</td><td class="c3"><input type="text" value="" class="vv offset in" placeholder="offset" style="width:50px"><span class="spl">(Integer)　※セットされていなければ0</span></td></tr>
<tr><th>レングス</th><td class="c2">-</td><td class="c3"><input type="text" value="" class="vv length in" placeholder="length" style="width:50px"><span class="spl">(Integer)　※セットされていなければ10</span></td></tr>
</table>
<span class="btns">データを確認</span>
...
<option value="<?=$article[$i]["id"]?>"><?=$article[$i]["id"]?> : <?=$article[$i]["title"]?></option>
<?php } ?>
...
<div class="apibox api32 clearfix pt20">
<table>
<tr class="thead"><th class="c1">項目名</th><td class="c2"><b>必須</b></td><td class="c3"><b>値</b></td></tr>
<tr><th>ページID</th><td class="c2">○</td><td class="c3"><select class="vv">
<?php for($i=0;$i<count($article);$i++){ ?>
...
$sql=sprintf("select id,comment,(select title from u_member where id=userid) as user from u_comment where pageid=%s and commentid=0 and flag=1",$article[0]["id"]);
$o->query($sql);
...
for($i=0;$i<count($p);$i++){
	...
	$sql=sprintf("select id,(select title from u_member where id=userid) as username,comment,regitime from u_comment where commentid=%s and flag=1 order by regitime desc",$p[$i]["id"]);
	$o->query($sql);
	while($f=$o->fetch_array()){
...
<tr><th>タイプ</th><td class="c2">○</td><td class="c3"><input type="text" value="" class="vv type in" placeholder="type" style="width:200px"><span class="spl">(String)　[like | bad]</span></td></tr>
</table>
<span class="btns">like,badする</span>
</div>
...
$sql="select t1.id,commentid,(select title from u_member where id=t1.userid) as user,reaction,pageid,comment from (select * from u_reaction) as t1,(select id,pageid,comment,userid from u_comment where flag=1) as t2 where t1.commentid=t2.id order by regitime desc";
$o->query($sql);

while($f=$o->fetch_array()){

?>
<option value="<?=$f["commentid"]?>" class="rc<?=$f["reaction"]?>"><?=$f["user"]?>：[<?=$f["reaction"]==1?"like":"bad"?>]：<?=mb_substr($f["comment"],0,25)?></option>
<?php } ?>
</select><span class="spl">(Integer)　※投稿者とログインユーザが一致する場合のみ削除できます。</span></td></tr>
</table>
<span class="btns">like,bad削除</span>
</div>
...
$sql="select id,title,a15 from u_member where qid=2 and flag=1 order by cid,n limit 100 offset 0";
$o->query($sql);
...
<form enctype="multipart/form-data" class="account">
<table>
<tr class="thead"><th class="c1">項目名</th><td class="c2"><b>必須</b></td><td class="c3"><b>値</b></td></tr>
<tr><th>カテゴリーID</th><td class="c2">○</td><td class="c3"><ul class="clearfix">
<?php
...
?>
<li><input type="checkbox" value="<?=$f["id"]?>" name="interest[]"><?=$f["name"]?></li>
<?php } ?>
</ul></td></tr>
</table>
</form>
<span class="btns">データを更新</span>
</div>
...
<!--
<tr><th>Facebook ID</th><td class="c2">-</td><td class="c3"><input type="text" name="facebook_id" value="" class="vv offset in" placeholder="" style="width:250px"><span class="spl">(String)</span></td></tr>
<tr><th>Facebook Token</th><td class="c2">-</td><td class="c3"><input type="text" name="facebook_token" value="" class="vv offset in" placeholder="" style="width:700px"><span class="spl">(String)</span></td></tr>
<tr><th>Twitter ID</th><td class="c2">-</td><td class="c3"><input type="text" name="twitter_id" value="" class="vv offset in" placeholder="" style="width:250px"><span class="spl">(String)</span></td></tr>
<tr><th>Twitter Token</th><td class="c2">-</td><td class="c3"><input type="text" name="twitter_token" value="" class="vv offset in" placeholder="" style="width:700px"><span class="spl">(String)</span></td></tr>
-->
</table>
</form>
<span class="btns">データを確認</span>
...
<table>
<tr class="thead"><th class="c1">項目名</th><td class="c2"><b>必須</b></td><td class="c3"><b>値</b></td></tr>
<tr><th>メールアドレス</th><td class="c2">○</td><td class="c3"><input type="text" name="email" value="psychsa@gmail.com" class="vv offset in" placeholder="" style="width:250px"><span class="spl">(String)</span></td></tr>
<tr><th>パスワード</th><td class="c2">○</td><td class="c3"><input type="password" name="password" value="bmpzdh00" class="vv length in" placeholder="" style="width:250px"><span class="spl">(String) ※8文字以上の英数字で入力してください。</span></td></tr>
</table>
...
<div class="apibox api29 clearfix pt20">
<table>
<tr class="thead"><th class="c1">項目名</th><td class="c2"><b>必須</b></td><td class="c3"><b>値</b></td></tr>
<tr><th>メールアドレス</th><td class="c2">○</td><td class="c3"><input type="text" name="email" value="" class="vv offset in" placeholder="" style="width:250px"><span class="spl">(String)</span></td></tr>
</table>
<span class="btns">emailを確認</span>
</div>

<div class="apibox api30 clearfix pt20">
<table>
<tr class="thead"><th class="c1">項目名</th><td class="c2"><b>必須</b></td><td class="c3"><b>値</b></td></tr>
<tr><th>種別</th><td class="c2">○</td><td class="c3"><input type="text" name="service" value="facebook" class="vv offset in" placeholder="" style="width:250px"><span class="spl">(String)</span></td></tr>
<tr><th>ユーザID</th><td class="c2">○</td><td class="c3"><input type="text" name="id" value="1025239190881987" class="vv offset in" placeholder="" style="width:250px"><span class="spl">(String)</span></td></tr>
<tr><th>トークン</th><td class="c2">○</td><td class="c3"><input type="text" name="token" value="CAAClDVTIPUMBAHRx7GC0pjAu7N3fgiDDot4a1cqnnbZC2xAxZAFEZAm86nFei09xMANfrPYOEZC24VX0OOyZAZAtNyyr3fxZCmiBy3eZA7ZCQpyFFxwtntuwWR7lfd9wcVU0w4TjUqhtl1DsPh2g3j8C4WJg4yRZAZA6xrfGP4NkN5S3XZAj4XIp6JofmkMEZBy5ZCnov2AnC5ZCl0tQAZDZD" class="vv length in" placeholder="" style="width:550px"><span class="spl">(String)</span></td></tr>
</table>
<span class="btns">ログイン</span>
</div>


<div class="apibox api31 clearfix pt20">
<table>
<tr class="thead"><th class="c1">項目名</th><td class="c2"><b>必須</b></td><td class="c3"><b>値</b></td></tr>
<tr><th>カテゴリー</th><td class="c2">○</td><td class="c3"><select class="vv">
<?php for($i=1;$i<count($api2);$i++){ ?>
<option value="<?=$api2[$i][0]?>"<?=$api2[$i][0]==$_SERVER['REQUEST_URI']?" selected=\"selected\"":""?>><?=$api2[$i][1]?></option>
<?php } ?>
</select></td></tr>
</table>
