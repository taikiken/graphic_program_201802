...
$sql=sprintf("update %s set ng_flag%s=%s where id=%s",$_POST["table"],$_POST["lang"],$_POST["ng_flag"],$_POST["id"]);
$o->query($sql);

if(strlen($_POST["lang"])>0&&$_POST["table"]=="repo_n"&&$_POST["ng_flag"]==1){
