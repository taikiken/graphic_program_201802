...
*/
$MEDIAID = 67;
const MEDIA_NAME = 'Dews';


# RSSファイル
#
#
const RSS_FILE = 'http://dews365.com/?feed=sportsbull';
...
foreach($items as $item)
{
	...
	#
	#画像
	#http://dews365.com/wp-content/uploads/2017/10/20171005-Dews-Dance-Earth-Party-36.jpg
	...
	#
   // $modbody = modifyimg(str_replace('<p>&nbsp;</p>', '', str_replace("\'","''",preg_replace('/(\r|\n|\t)/', '', $body))));

    $modbody = modifytag_New(str_replace('<p>&nbsp;</p>', '', str_replace("\'","''",preg_replace('/(\r|\n|\t)/', '', $body))),$enclosure_url);
