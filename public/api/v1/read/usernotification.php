...
if(strlen($uid)>0){
	...
	$fls=array("id","commentid","userid","comment","regitime","isotime","flag","relativetime","pid","typeid","type","name","profile","icon");
