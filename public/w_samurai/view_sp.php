        ...
        <div class="yellfor">
          <div class="yellfor__section yellfor--soccer">
            ...
            <ul class="yellfor__btns">
              ...
              <li class="yellfor__btns__item"><a href="https://sportsbull.jp/sokuhou/" target="_blank"><img src="/assets/sp/images/w_samurai/soccer-btn_live.png" alt="試合速報はこちら"></a></li>
            </ul><!-- /.yellfor__btns -->
          ...
          <div class="yellfor__section yellfor--baseball">
            ...
            <ul class="yellfor__btns">
              ...
              <li class="yellfor__btns__item"><a href="https://sportsbull.jp/wbc/" target="_blank"><img src="/assets/sp/images/w_samurai/baseball-btn_live.png" alt="試合速報はこちら"></a></li>
            </ul><!-- /.yellfor__btns -->
          </div><!-- /.yellfor__section -->
        </div><!-- /.yellfor -->
