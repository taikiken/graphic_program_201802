      ...
      <section class="main-sec">
        ...
        <div class="gift">
          ...
          <section class="gift__section gift--baseball">
            <h2 class="gift__heading"><img src="/assets/images/w_samurai/campaign/gift-baseball-figure.png" alt="野球日本代表賞"></h2>
        ...
        <section class="guidance">
          ...
          <dl class="guidance__item guidance--term">
            ...
            <dd>
              <p><strong>野球日本代表賞</strong> 2月20日（月）〜2月28日（火）</p>
          ...
          <div class="guidance__bnr">
            ...
            <div class="guidance__bnr__btn"><a href="/about/" target="_blank"><img src="/assets/images/w_samurai/campaign/bnr-app.png" alt="アプリをダウンロードして会員登録しよう！"></a></div>
          </div><!-- /.guidance__bnr -->
        </section><!-- /.guidance -->
        ...
        <div class="yellfor">
          <div class="yellfor__section yellfor--soccer">
            ...
            <ul class="yellfor__btns">
              <li class="yellfor__btns__item"><a href="https://dev.sportsbull.jp/p/90825/"><img src="/assets/images/w_samurai/campaign/yellfor-soccer-btn_highlight.png" alt="試合日程・ハイライト動画"></a></li>
          ...
          <div class="yellfor__section yellfor--baseball">
            ...
            <ul class="yellfor__btns">
              <li class="yellfor__btns__item"><a href="https://dev.sportsbull.jp/p/90822/"><img src="/assets/images/w_samurai/campaign/yellfor-baseball-btn_highlight.png" alt="試合日程・ハイライト動画"></a></li>
