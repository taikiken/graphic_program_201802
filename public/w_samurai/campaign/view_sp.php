      ...
      <section class="main-sec">
        ...
        <div class="gift">
          ...
          <section class="gift__section gift--baseball">
            <h2 class="gift__heading"><img src="/assets/sp/images/w_samurai/campaign/gift-baseball-figure.png" alt="【応募期間は終了いたしました】野球日本代表賞"></h2>
        ...
        <div class="yellfor">
          <div class="yellfor__section yellfor--soccer">
            ...
            <ul class="yellfor__btns">
              <li class="yellfor__btns__item"><a href="https://sportsbull.jp/p/103261/"><img src="/assets/sp/images/w_samurai/campaign/yellfor-soccer-btn_highlight.png" alt="試合日程・ハイライト動画"></a></li>
              <li class="yellfor__btns__item"><a href="https://sportsbull.jp/sokuhou/" target="_blank"><img src="/assets/sp/images/w_samurai/campaign/yellfor-soccer-btn_live.png" alt="試合速報はこちら"></a></li>
            </ul><!-- /.yellfor__btns -->
          ...
          <div class="yellfor__section yellfor--baseball">
            ...
            <ul class="yellfor__btns">
              ...
              <li class="yellfor__btns__item"><a href="https://sportsbull.jp/wbc/" target="_blank"><img src="/assets/sp/images/w_samurai/campaign/yellfor-baseball-btn_live.png" alt="試合速報はこちら"></a></li>
            </ul><!-- /.yellfor__btns -->
          </div><!-- /.yellfor__section -->
        </div><!-- /.yellfor -->
