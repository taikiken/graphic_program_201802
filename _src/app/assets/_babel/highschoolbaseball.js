...
// highschoolbaseball sidebar ranking
...
const video = () => {
  ...
  option[View.DID_MOUNT] = didVideo;
  const viewVideos = new ViewVideos(videoElement, option, 'highschoolbaseball');
  viewVideos.start();
};
...
const recommend = () => {
  ...
  const viewRecommend = new ViewRecommend(recommendElement, {}, 'highschoolbaseball');
  viewRecommend.start();
};
