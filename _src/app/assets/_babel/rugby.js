...
var ranking = function ranking() {
  ...
  var viewRanking = new ViewRanking(rankingElement, option, 'rugby');
  viewRanking.start();
};
...
var video = function video() {
  ...
  option[View.DID_MOUNT] = didVideo;
  var viewVideos = new ViewVideos(videoElement, option, 'rugby');
  viewVideos.start();
};
...
var recommend = function recommend() {
  ...
  var viewRecommend = new ViewRecommend(recommendElement, {}, 'rugby');
  viewRecommend.start();
};
