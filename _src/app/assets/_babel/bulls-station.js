...
const ranking = () => {
  ...
  const viewRanking = new ViewRanking(rankingElement, option, 'station');
  viewRanking.start();
};
...
const video = () => {
  ...
  const viewVideos = new ViewVideos(videoElement, option, 'station');
  viewVideos.start();
};
...
const recommend = () => {
  ...
  const viewRecommend = new ViewRecommend(recommendElement, {}, 'station');
  viewRecommend.start();
};
