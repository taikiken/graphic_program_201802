...
const ranking = () => {
  ...
  const viewRanking = new ViewRanking(rankingElement, option, 'motorsports');
  viewRanking.start();
};
...
const video = () => {
  ...
  const viewVideos = new ViewVideos(videoElement, option, 'motorsports');
  viewVideos.start();
};
...
const recommend = () => {
  ...
  const viewRecommend = new ViewRecommend(recommendElement, {}, 'motorsports');
  viewRecommend.start();
};
