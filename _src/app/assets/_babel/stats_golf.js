...
const ranking = () => {
  ...
  const viewRanking = new ViewRanking(rankingElement, option, 'golf');
  viewRanking.start();
};
...
const video = () => {
  ...
  const viewVideos = new ViewVideos(videoElement, option, 'golf');
  viewVideos.start();
};
...
const recommend = () => {
  ...
  const viewRecommend = new ViewRecommend(recommendElement, {}, 'golf');
  viewRecommend.start();
};
