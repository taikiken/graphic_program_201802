...
var ranking = function ranking() {
  ...
  var viewRanking = new ViewRanking(rankingElement, option, 'big6tv');
  viewRanking.start();
};
...
var video = function video() {
  ...
  option[View.DID_MOUNT] = didVideo;
  var viewVideos = new ViewVideos(videoElement, option, 'big6tv');
  viewVideos.start();
};
...
var recommend = function recommend() {
  ...
  var viewRecommend = new ViewRecommend(recommendElement, {}, 'big6tv');
  viewRecommend.start();
};
