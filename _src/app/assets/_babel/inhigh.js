...
const ranking = () => {
  ...
  const viewRanking = new ViewRanking(rankingElement, option, 'inhigh');
  viewRanking.start();
};
...
const video = () => {
  ...
  const viewVideos = new ViewVideos(videoElement, option, 'inhigh');
  viewVideos.start();
};
...
const recommend = () => {
  ...
  const viewRecommend = new ViewRecommend(recommendElement, {}, 'inhigh');
  viewRecommend.start();
};
