...
const ranking = () => {
  ...
  const viewRanking = new ViewRanking(rankingElement, option, 'tennis');
  viewRanking.start();
};
...
const video = () => {
  ...
  const viewVideos = new ViewVideos(videoElement, option, 'tennis');
  viewVideos.start();
};
...
const recommend = () => {
  ...
  const viewRecommend = new ViewRecommend(recommendElement, {}, 'tennis');
  viewRecommend.start();
};
