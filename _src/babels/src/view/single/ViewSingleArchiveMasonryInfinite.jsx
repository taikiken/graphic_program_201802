...
// view/articles
import { ComponentSinglesArticlesMasonryInfinite } from '../../component/singles/ComponentSinglesArticlesMasonryInfinite';
 ...
 * - {@link ComponentSinglesArticlesMasonryInfinite}
 */
export default class ViewSingleArchiveMasonryInfinite extends View {
  /**
  ...
  fail(error) {
    ...
    // this.showError( error.message );
    console.warn('ViewSingleArchiveMasonryInfinite.fail', error, this);
  }
  // /**
  ...
  //   // error.render();
  //   console.warn('ViewSingleArchiveMasonryInfinite.showError', message);
  // }
  /**
   * dom を render します
  ...
  render(articles) {
    ...
    if (!this.firstRendered) {
      ...
      if (this.home) {
        ...
        Ga.add(new GaData('ViewSingleArchiveMasonryInfinite.render', 'home_articles', 'view - new', String(1), 0, true));
        // ----------------------------------------------
      } else {
        // ----------------------------------------------
        // GA 計測タグ
        // PC/スマホカテゴリー一覧の新着記事
        Ga.add(new GaData('ViewSingleArchiveMasonryInfinite.render', `${this.slug}_articles`, 'view - new', String(1), 0, true));
        // ----------------------------------------------
      }
    }// first rendered
    // ---------------------
    const adgene = element.getAttribute('data-adgene-id').split(',');

    ReactDOM.render(
      <ComponentSinglesArticlesMasonryInfinite
        list={articlesList}
        home={this.home}
