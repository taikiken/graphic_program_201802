...
import ComponentDeactivate from '../../component/signup/ComponentDeactivate';
...
/**
 * 退会 表示
 * - {@link ComponentDeactivate}
 *   - {@link ComponentDeactivateModal}
 */
export default class ViewDeactivate extends View {
  // ---------------------------------------------------
  //  CONSTRUCTOR
  // ---------------------------------------------------
  /**
   ...
   */
  constructor(element, modalElement, option = {}) {
