...
import ComponentBookmarks from '../../component/mypage/ComponentBookmarks';
 ...
 * my page bookmark 一覧
 */
export default class ViewBookmarks extends View {
  /**
  ...
  fail(error) {
    ...
    // console.log('ViewBookmarks.fail', error);
  ...
  render(articles) {
    ...
    // console.log('ViewBookmarks.render articlesList ', articlesList);
    //
