...
// view/categories
import ComponentHeadlineAd from '../categories/ComponentHeadlineAd';
 ...
 * @since 2016-09-20
 */
export default class ComponentSingleHeadlineOption extends React.Component {
  // ---------------------------------------------------
  ...
  //  * @param {Object} props プロパティ {@link ComponentSingleHeadlineOption.propTypes}
  //  */
  // constructor(props) {
  //   super(props);
  // }
   ...
   */
  render() {
    const list = this.props.list.splice(0, 5);
    if (list.length === 0) {
      return null;
    }
