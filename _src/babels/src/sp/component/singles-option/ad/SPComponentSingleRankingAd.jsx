...
export default class SPComponentSingleRankingAd extends React.Component {
  ...
  constructor(props) {
     ...
     */
    this.src = {
      first: '//i.socdm.com/sdk/js/adg-script-loader.js?id=54991&targetID=adg_54991&displayid=3&adType=INFEED&async=false&tagver=2.0.0',
      second: '//i.socdm.com/sdk/js/adg-script-loader.js?id=54992&targetID=adg_54992&displayid=3&adType=INFEED&async=false&tagver=2.0.0',
    };
  }
  // ---------------------------------------------------
  //  METHOD
