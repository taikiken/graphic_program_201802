...
// sp/view/articles
import SPComponentSingleNewsAd from './SPComponentSingleNewsAd';
 ...
 * @since 2016-09-21
 */
export default class SPComponentSingleNews extends React.Component {
  // ---------------------------------------------------
   ...
   * @param {Object} props React props プロパティー {@link SPComponentSingleNews.propTypes}
   */
  constructor(props) {
    super(props);
