...
// component
import SPSearchErrorComponent from '../component/search/SPSearchErrorComponent';
...
export default class SPViewSearch extends SPViewArchiveInfinite {
  /**
   * SP 検索結果
