        ...
        <div className="linkage-sns">
          <ul className="linkage-sns-list">
            <li className="linkage-sns-item">
              ...
              <a href={Api.auth('tw').url} className="linkage-sns-link linkage-sns-tw"><span>twitterでログイン</span></a>
            </li>
            <li className="linkage-sns-item">
              <a href={Api.auth('fb').url} className="linkage-sns-link linkage-sns-fb"><span>facebookでログイン</span></a>
            </li>
          </ul>
        </div>
