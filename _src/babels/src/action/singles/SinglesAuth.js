...
/**
 * 記事詳細次の記事一覧を取得します + ログインユーザー token
 *
 * `/api/v1/articles/{:article_id}/next?offset=NN&length=10`
 * @since 2016-09-26
 */
export class SinglesAuth extends OffsetAuth {
  /**
  ...
  constructor(id:Number, resolve:Function = null, reject:Function = null, offset:Number = 0, length:Number = Length.list) {
    super(User.token, Api.singles(), resolve, reject, offset, length);
    /**
     * 記事ID
     * @type {Number}
     */
