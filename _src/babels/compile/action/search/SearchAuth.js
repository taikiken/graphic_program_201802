...
var SearchAuth = exports.SearchAuth = function (_OffsetAuth) {
  (0, _inherits3.default)(SearchAuth, _OffsetAuth);
  ...
  function SearchAuth(word) {
    ...
    (0, _classCallCheck3.default)(this, SearchAuth);

    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(SearchAuth).call(this, _User.User.token, _Api.Api.search(), resolve, reject, offset, length));
  ...
  (0, _createClass3.default)(SearchAuth, [{
    key: 'word',
    get: function get() {
      return this._word;
    }
