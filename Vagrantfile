...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.push.define "dev", strategy: "local-exec" do |push|
    push.inline = <<-SCRIPT
      ...
      rsync -vrt --chmod=Dug=rwx,Dg+s,Do=rx,Fu=rw,Fg=rw,Fo=r --perms --progress --delete --exclude='.DS_Store' ./public/single_content #{_conf['ssh_user']}@#{_conf['ssh_host']}:/var/www/sportsbull.jp/dev/public/
  ...
  config.push.define "stg", strategy: "local-exec" do |push|
    push.inline = <<-SCRIPT
      ...
      rsync -vrt --chmod=Dug=rwx,Dg+s,Do=rx,Fu=rw,Fg=rw,Fo=r --perms --progress --delete --exclude='.DS_Store' ./public/single_content #{_conf['ssh_user']}@#{_conf['ssh_host']}:/var/www/sportsbull.jp/stg/public/
  ...
  config.push.define "www", strategy: "local-exec" do |push|
    push.inline = <<-SCRIPT
      ...
      rsync -vrt --chmod=Dug=rwx,Dg+s,Do=rx,Fu=rw,Fg=rw,Fo=r --perms --progress --delete --exclude='.DS_Store' ./public/single_content #{_conf['ssh_user']}@#{_conf['ssh_host_cms']}:/var/www/sportsbull.jp/www/public/
