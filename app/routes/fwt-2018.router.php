...
$app->group('/fwt',  function () use($app) {
  ...
  $page = array(
    'title'              => 'Freeride World Tour Hakuba, Japan 2018 ライブ配信',
    'site_name'          => 'スポーツブル (スポブル)',
    'og_type'            => 'article',
    'og_title'           => 'Freeride World Tour Hakuba, Japan 2018 ライブ配信 | '.$app->model->property('title'),
    'og_url'             => $app->model->property('site_url').'fwt/',
    'og_image'           => $app->model->property('site_url').'assets/images/fwt/ogp.png',
    'og_description'     => '断崖絶壁の雪山レースが日本初上陸！Freeride World Tour Hakuba,Japan 2018をスポーツブルで無料ライブ配信。スポーツブル(スポブル)は、インターネットスポーツメディアです。数十社の良質なスポーツ媒体と連携し、話題のスポーツニュース記事、動画をいち早くお届けします。また、ここでしか見ることの出来ないオリジナル記事や、番組を配信しています。スマートフォンはもちろん、PC、タブレットでもお楽しみいただけます。',
    'keywords'           => 'Freeride World Tour Hakuba,Japan 2018,スポブル,ライブ配信,スポーツ,メディア,クレイジー,アスリート,ニュース,動画,sports,media,crazy',
    'template'           => 'index',
