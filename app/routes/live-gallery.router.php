...
// live-gallery
// ==============================
$app->group('/live-gallery',  function () use($app) {
  ...
  $page = array(
    ...
    'og_image'           => $app->model->property('site_url').'assets/images/live/red-bull-neymar-jrs-five-2018/ogp.png',
  ...
  $this->get('/live[/]', function ($request, $response, $args) use ($app, $page) {
    return $response->withRedirect('/live-gallery/', 301);
  });
  ...
  $this->map(['GET'], '[/]', function ($request, $response, $args) use ($app, $page) {
    ...
    return $this->renderer->render($response, 'live-gallery/index.php', $args);
