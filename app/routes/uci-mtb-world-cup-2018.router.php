...
$app->group('/live/uci-mtb-world-cup-2018',  function () use($app) {
  ...
  $page = array(
    'title'              => 'UCI MOUNTAIN BIKE WORLD CUP 2018 ライブ配信',
    'og_title'           => 'UCI MOUNTAIN BIKE WORLD CUP 2018 ライブ配信 | '.$app->model->property('title'),
    'og_url'             => $app->model->property('site_url').'uci-mtb-world-cup-2018/',
    'og_image'           => $app->model->property('site_url').'assets/images/live/uci-mtb-world-cup-2018/ogp.png',
    'og_description'     => 'UCI MOUNTAIN BIKE WORLD CUP 2018をスポーツブルで無料ライブ配信。ブルくんも挑戦！？スポーツブル(スポブル)は、インターネットスポーツメディアです。数十社の良質なスポーツ媒体と連携し、話題のスポーツニュース記事、動画をいち早くお届けします。また、ここでしか見ることの出来ないオリジナル記事や、番組を配信しています。スマートフォンはもちろん、PC、タブレットでもお楽しみいただけます。',
