      ...
      <section class="main-sec">
        <div class="headline-outer">
          ...
          <div class="sponsor-link">
            ...
            -->
            <script src="http://i.socdm.com/sdk/js/adg-script-loader.js?id=34481&targetID=adg_34481&displayid=2&adType=PC&width=0&height=0&sdkType=3&async=false&tagver=2.0.0"></script>
          </div>
        </div><!-- /.headline-outer -->
