        ...
        <?php if(empty($page['list']) === false) : ?>
          <section class="section_pickup_player">
              <div class="ttl-wrapper">
                  ...
                  <p class="more"><a href="/category/crazy/athletes/">すべての選手を見る</a></p>
              </div>
              <div class="pickup_player_list">
                  <ul class="thumb_area">
                      <?php foreach ($page['list'] as $player): ?>
                        <li>
                            <a href="/athlete/<?php echo $player->body->no ?>/<?php echo $page['categpry']['slug'] ?>/">
