...
<div class="holyride__container holyride__container--even holyride--course">
  ...
  <figure class="course__map">
    ...
    <figcaption>
      ...
      今大会は、千光寺→千光寺新道→宝土寺の高低差約100メートル、最大斜度約30度、石段300段の一般公道を含む大会史上最長となる全長約1,400メートルのコースを設ける予定です。</p>
...
<div class="holyride__container holyride__container--odd holyride--overview">
  ...
  <table class="overview__data">
    <tbody>
      ...
      <tr>
        <th>会場</th>
        <td>広島県尾道市千光寺山周辺（千光寺→千光寺新道→宝土寺）</td>
      </tr>
      <tr>
        <th>内容</th>
...
<div class="holyride--related holyride__container--even holyride__container">
  ...
  <div class="related__post">
    <a href="https://sportsbull.jp/p/181231/">
      <figure class="related__post__thumb"><img src="/assets/images/red-bull-holy-ride/related-post-figure5.png" alt=""></figure>
      <div class="related__post__text">
        <h3 class="related__post__heading">【写真で振り返る】Red Bull Holy Ride Japan 2011</h3>
        <h4 class="related__post__category">アクションスポーツ</h4>
