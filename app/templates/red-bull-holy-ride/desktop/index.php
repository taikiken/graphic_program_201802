...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# <?php echo $page['og_type']; ?>: http://ogp.me/ns/<?php echo $page['og_type']; ?>#">
  ...
  <link rel="stylesheet" href="/assets/css/red-bull-holy-ride/ui.css?v=<?php echo $page['version']; ?>">
...
<body>
<div id="whole" class="whole dark red-bull-holy-ride <?php echo $page['template_classname']; ?>">
  ...
  <div class="body-sec">
    <div class="special-summary">
      <h1 class="special-summary-heading"><img src="/assets/images/red-bull-holy-ride/summary-heading.png" alt="RED BULL HOLY RIDE 2017"></h1>
      <p class="special-summary-copy">型破りなMTBダウンヒル・レース<br />
      「Red Bull Holy Ride 2017」をスポーツブルで無料ライブ配信！</p>
    </div><!-- /.special-summary -->
      ...
      <section class="main-sec">
        ...
        <div class="holyride__container holyride__container--odd holyride--intro">
          ...
          <div class="intro__banner">
            <a href="hoge" target="_blank"><img src="/assets/images/red-bull-holy-ride/intro-banner.jpg" alt="Red Bull TV"></a>
          </div>

          <div class="intro__widjet_twitter">
            <a class="twitter-timeline" href="https://twitter.com/redbulljapan" data-height="400" data-chrome="noheader nofooter transparent" data-link-color="#be0940" data-border-color="#282d35">Tweets by redbulljapan</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
          </div><!-- /.widjet_twitter -->
        </div><!-- /.holyride--intro -->
        ...
        <div class="holyride__container holyride__container--even holyride--course">
          ...
          <div class="course__staff">
            ...
            <div class="course__staff__container">
              <figure class="course__staff__thumb"><img src="/assets/images/red-bull-holy-ride/course-staff1-figure.png" alt=""></figure>
            ...
            <div class="course__staff__container">
              <figure class="course__staff__thumb"><img src="/assets/images/red-bull-holy-ride/course-staff2-figure.png" alt=""></figure>
