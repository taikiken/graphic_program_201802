            ...
            <ul class="bulls_station__overview__caster__list">
              <li class="bulls_station__overview__caster__item bulls_station__overview__caster__item--mon">
                <figure class="bulls_station__overview__caster__figure">
                  <h3 class="bulls_station__overview__caster__figure__heading"><img src="/assets/sp/images/bulls-station/caster-figure1.png" alt="エイミー"></h3>
              ...
              <li class="bulls_station__overview__caster__item bulls_station__overview__caster__item--tue">
                <figure class="bulls_station__overview__caster__figure">
                  <h3 class="bulls_station__overview__caster__figure__heading"><img src="/assets/sp/images/bulls-station/caster-figure2.png" alt="サヤカ"></h3>
              ...
              <li class="bulls_station__overview__caster__item bulls_station__overview__caster__item--wed">
                <figure class="bulls_station__overview__caster__figure">
                  <h3 class="bulls_station__overview__caster__figure__heading"><img src="/assets/sp/images/bulls-station/caster-figure3.png" alt="エレナ"></h3>
              ...
              <li class="bulls_station__overview__caster__item bulls_station__overview__caster__item--thu">
                <figure class="bulls_station__overview__caster__figure">
                  <h3 class="bulls_station__overview__caster__figure__heading"><img src="/assets/sp/images/bulls-station/caster-figure4.png" alt="イチカ"></h3>
              ...
              <li class="bulls_station__overview__caster__item bulls_station__overview__caster__item--fri">
                <figure class="bulls_station__overview__caster__figure">
                  <h3 class="bulls_station__overview__caster__figure__heading"><img src="/assets/sp/images/bulls-station/caster-figure5.png" alt="ライカ"></h3>
