...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# <?php echo $page['og_type']; ?>: http://ogp.me/ns/<?php echo $page['og_type']; ?>#">
  ...
  <link rel="stylesheet" href="/assets/css/live/live-gallery/ui.css?v=<?php echo $page['version']; ?>">
...
<div id="whole" class="whole dark">
  ...
  <div class="body-sec">
        <div class="mainimg" style="overflow: hidden;">
          <img src="/assets/images/live/live-gallery/mv_live_gallery.png" class="mainimg-img">
        </div>
      ...
      for(var i in data.bannerLists){
        for(var j in data.bannerLists[i].banners){
          <?php if ($page['ua'] == 'desktop') : ?>
            $("#js-live-lists").append("<li><a href='"+data.bannerLists[i].banners[j].url+"'><p>"+data.bannerLists[i].banners[j].date+"配信</p><img src='"+data.bannerLists[i].banners[j].image.pc+"''></a></li>");
          <?php else : ?>
            $("#js-live-lists").append("<li><a href='"+data.bannerLists[i].banners[j].url+"'><p>"+data.bannerLists[i].banners[j].date+"配信</p><img src='"+data.bannerLists[i].banners[j].image.sp+"''></a></li>");
          <?php endif ; ?>
        }
      }
    });
