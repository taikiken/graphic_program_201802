...
<?php endif; ?>
  ...
  <script src="/assets/js/libs/sagen/sagen.min.js?v=20160613" id="sagen" data-browser="true" data-orientation="true"></script>
<?php
# ---------------------------------------------------------------------------
# botと思われるアクセスは判定しない
if ( !$page['ua_is_bot'] ) :
...
if ( $about_browser != $current_path ) {
  ...
  ?>
  <script src="/assets/js/detector.js?v=20160613" id="detector" data-chrome="48" data-safari="8" data-firefox="44" data-ie="11" data-edge="13" data-ios="8" data-android="4.2" data-url="<?php echo $about_browser; ?>"></script>
