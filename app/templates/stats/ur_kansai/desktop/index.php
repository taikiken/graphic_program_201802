...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
  ...
  <title>関西学生アメリカンフットボールリーグ | 速報 & データ | SPORTS BULL</title>
  ...
  <meta property="og:image" content="https://sportsbull.jphttps://sportsbull.jp/assets/images/common/og_image.png">
  ...
  <meta name="twitter:image" content="https://sportsbull.jphttps://sportsbull.jp/assets/images/common/og_image.png">
  <meta name="twitter:url" content="">
  <meta name="twitter:description" content="">

  <link rel="canonical" href="">
  <link rel="apple-touch-icon" sizes="180x180" href="https://sportsbull.jphttps://sportsbull.jp/assets/sp/images/common/apple-touch-icon.png">
  <link rel="apple-touch-icon-precomposed" href="https://sportsbull.jphttps://sportsbull.jp/assets/sp/images/common/apple-touch-icon.png">
  <link rel="icon" sizes="192x192" href="https://sportsbull.jphttps://sportsbull.jp/assets/sp/images/common/apple-touch-icon.png">
...
<div id="whole" class="whole dark">
  ...
  <footer class="foot-sec show-for-small">
    <div class="foot-sec-inner">
      ...
      <div class="foot-pr">
        <div class="foot-pr-inner">
          <figure class="foot-pr-logo"><img src="https://sportsbull.jp/assets/sp/images/common/footer-overview-logo.png" alt="SPORTS BULL"></figure>
          <div class="text-block">
            <h3 class="foot-pr-heading">スポーツブルアプリをダウンロード</h3>
            <ul class="foot-pr-list">
              <li class="foot-pr-item"><a class="foot-pr-link" href="https://itunes.apple.com/jp/app/undotsushin/id1086719653?l=ja&ls=1&mt=8" target="_blank"><img src="https://sportsbull.jp/assets/sp/images/common/footer-overview-btn-applestore.png" alt="App Store" /></a></li>
              <li class="foot-pr-item"><a class="foot-pr-link" href="https://play.google.com/store/apps/details?id=com.undotsushin" target="_blank"><img src="https://sportsbull.jp/assets/sp/images/common/footer-overview-btn-googleplay.png" alt="Google play"></a></li>
            </ul>
          </div>
        </div><!-- /.foot-pr-inner -->
