...
<html dir="ltr" lang="ja">
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
        ...
        <meta property="og:title" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx | スポーツブル (スポブル)">
        <meta property="og:image" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">
        <meta property="og:url" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">
        <meta property="og:description" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">
        <meta property="og:locale" content="ja_JP" />
        <!-- twitter card -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:site" content="@sportsbull_jp">
        <meta name="twitter:title" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx | スポーツブル (スポブル)">
        <meta name="twitter:image" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">
        <meta name="twitter:url" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">
        <meta name="twitter:description" content="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">
            ...
            <div class="body-sec">
                <div class="body-sec-inner">
                    <section class="main-sec">
                        <div class="stats__header stats__header--worldsoccer">
                            <h1 class="stats__header__title">
                                <img src="/assets/images/stats/worldsoccer/img-header-pc.jpg" class="show-for-large">
                                <img src="/assets/images/stats/worldsoccer/img-header-sp.jpg" class="show-for-small"> </h1>
                        </div>
                        <!-- /.stats__header -->
                        <div class="stats__banner show-for-large">
                            ...
                            <div id='div-gpt-ad-1498734753639-0' style='height:90px; width:728px;'>
                                <script>
                                    googletag.cmd.push(function()
                                    {
                                        googletag.display('div-gpt-ad-1498734753639-0');
                                    });
                                </script>
                            </div>
                            <!-- // /531683568/golf-stats-ad/golf-stats-under-header-PC -->
                        ...
                        <!-- /.stats__banner -->
                        <div class="stats__banner show-for-small">
                            ...
                            <div id='div-gpt-ad-1498734782114-0' style='height:50px; width:320px;'>
                                <script>
                                    googletag.cmd.push(function()
                                    {
                                        googletag.display('div-gpt-ad-1498734782114-0');
                                    });
                                </script>
                            </div>
                            <!-- // /531683568/golf-stats-ad/golf-stats-under-header-SP -->
                        ...
                        <div class="stats__nav stats__nav--worldsoccer">
                            <ul class="stats__nav__list">
                                <li class="stats__nav__item_1">
                                    <a href="/stats/worldsoccer/premier-league">プレミアリーグ</a>
                                </li>
                                <li class="stats__nav__item_2">
                                    <a href="/stats/worldsoccer/bundesliga">ブンデス・リーガ</a>
                                </li>
                                <li class="stats__nav__item_3">
                                    <a href="/stats/worldsoccer/champions-league">チャンピオンズリーグ</a>
                                </li>
                                <li class="stats__nav__item_4">
                                    <a href="/stats/worldsoccer/la-liga">リーガ・エスパニョーラ</a>
                                </li>
                                <li class="stats__nav__item_5 active">
                                    <a href="/stats/worldsoccer/serie-a">セリエA</a>
                                </li>
                            </ul>
                        </div>
                        <div class="stats__local__nav stats__local__nav--worldsoccer">
                            <ul class="stats__local__nav__list">
                                <li class="stats__local__nav__item_1 active">
                                    <a href="../schedule">試合日程</a>
                                </li>
                                <li class="stats__local__nav__item_2">
                                    <a href="../standing">順位表</a>
                                </li>
                                <li class="stats__local__nav__item_3">
                                    <a href="../playlist">選手情報</a>
                                </li>
                                <li class="stats__local__nav__item_4">
                                    <a href="../team">チーム情報</a>
                                </li>
                            </ul>
                        </div>
                        <!-- 詳細埋め込み　ここから -->
                        <script src="//widgets.sports.gracenote.com/gns.widget.loader.js?c=1323" data-widget_id="kyodo_sportsbull-fb-matchdetail" data-match_id="2221604"></script>
                        <!-- 詳細埋め込み　ここまで -->
                    </section>
                    <!-- /.main-sec -->
                            ...
                            <div class="sponsor-link">
                                ...
                                <div id='div-gpt-ad-pc_sidebar_top' style='height:250px; width:300px;'>
                                    <script type='text/javascript'>
                                        googletag.cmd.push(function()
                                        {
                                            googletag.display('div-gpt-ad-pc_sidebar_top');
                                        });
                                    </script>
                                </div>
                            </div>
            ...
            <footer id="footer-container" class="foot-sec show-for-large">
                <div class="foot-sec-inner">
                        ...
                        <div class="foot-pr-inner">
                            ...
                            <div class="text-block">
                                <h3 class="foot-pr-logo">
                                    <img src="/assets/images/common/footer-overview-logo.png" alt="SPORTS BULL アプリ版(iPhone/Android)">
                                </h3>
                                <ul class="foot-pr-btn">
                                    <li>
                                        <a href="https://itunes.apple.com/jp/app/undotsushin/id1086719653?l=ja&ls=1&mt=8" target="_blank">
                                            <img src="/assets/images/common/footer-overview-btn-applestore.png" alt="App Store" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://play.google.com/store/apps/details?id=com.undotsushin" target="_blank">
                                            <img src="/assets/images/common/footer-overview-btn-googleplay.png" alt="Google play">
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="fnav-block">
                        <nav class="fnav">
                            <h3 class="fnav-logo">
                                <img src="/assets/images/common/footer-fnav-logo.png" alt="SPORTS BULL">
                            </h3>
                            <ul>
                                <li>
