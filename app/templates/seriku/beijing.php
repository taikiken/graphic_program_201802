...
<html dir="ltr" lang="ja">
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
        ...
        <title>世界陸上 北京大会ハイライト 動画特集 | スポーツブル / SPORTS BULL</title>
        <meta name="description" content="世界陸上 北京大会ハイライト 動画特集見るならスポーツブルで。スポーツブルは、インターネットスポーツメディアです。数十社の良質なスポーツ媒体と連携し、話題のスポーツニュース記事、動画をいち早くお届けします。また、ここでしか見ることの出来ないオリジナル記事や、番組を配信しています。スマートフォンはもちろん、PC、タブレットでもお楽しみいただけます。">
        <meta name="keywords" content="世界陸上,北京大会,ハイライト動画,動画特集,スポーツ,メディア,クレイジー,アスリート,ニュース,動画,sports,media,crazy">
        <!-- sns ogp -->
        ...
        <meta property="og:url" content="https://sportsbull.jp/seriku/beijing">
        ...
        <meta name="twitter:url" content="https://sportsbull.jp/seriku/beijing">
...
?>
                        ...
                        <div class="btn_area">
                            <div class="btn btn_another"><a href="/seriku/world-record/"><i class="icon_camera"></i>世界陸上で生まれた世界記録動画を見る</a></div>
