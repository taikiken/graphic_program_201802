      ...
      <div class="wowma_cpn__flow">
        ...
        <ul class="wowma_cpn__flow__list">
          ...
          <li class="wowma_cpn__flow__item wowma_cpn__flow__item--3">
            <h3 class="wowma_cpn__flow__item__heading"><img src="/assets/sp/images/wowma-campaign-171116/flow-flow3-heading.png" alt="3. 1万名限定！Wowma！で使える500円分のクーポンをプレゼント！"></h3>
