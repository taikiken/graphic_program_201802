...
<div class="body-sec category">
  <div class="body-sec-inner">
    ...
    <section class="main-sec">
      ...
      // ----------------------------------------------------
      // 記事一覧: sp banner
      if ( !empty($page['category']) && !empty($page['category']['banner']) && !empty($page['category']['banner']['sp']) && !empty($page['category']['banner']['sp']['image']) && !empty($page['category']['banner']['sp']['link']) ) :
        ?>
