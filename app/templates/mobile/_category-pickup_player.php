<style type="text/css">
  ...
  .section_pickup_player .more_btn {
    margin: 20px 10px 15px
  }

  .section_pickup_player .more_btn a {
    display: -webkit-box;
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
  ...
  .section_pickup_player .more_btn i {
    margin-right: 5px;
    position: relative;
    top: 0;
    display: inline-block;
    width: 12px;
    height: 12px;
    background: url(/assets/img/icon_list.png) 0 0/contain no-repeat
  }
  ...
  @media screen and (max-width: 768px) {
    ...
    .ttl-wrapper .ttl.pickup i, .ttl-wrapper .ttl.recommend i {
      width: 15px;
      height: 15px
    }
...
<section class="section_pickup_player">
  ...
  <div class="more_btn"><a href="/pickup_athletes/<?php echo $page['category']['slug'] ?>/list/"><i></i>すべての選手を見る</a>
  </div>
</section>