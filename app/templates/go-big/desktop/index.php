...
<div id="whole" class="whole dark <?php echo $page['template_classname']; ?>">
  ...
  <div class="body-sec">
    <div class="special-summary">
      <h1 class="special-summary-heading"><img src="/assets/images/go-big/summary-heading.png" alt="GO BIG 2017 - All JAPAN FMX CHAMPIONSHIP 2017"></h1>
      <div class="special-summary-catch"><img src="/assets/images/go-big/summary-catch.png" alt="10年目の進化を見届けろ"></div>
      <p class="special-summary-lead"><img src="/assets/images/go-big/summary-lead.png" alt="「GO BIG 2017」をスポーツブルで無料ライブ配信"></p>
    </div><!-- /.special-summary -->
      ...
      <section class="side-sec">
        <div id="sidebar-moving-container">
          ...
          <div class="sponsor-link">
            <!-- /531683568/go-big-ad/go-big_pc_recrangle -->
            <script>
              googletag.cmd.push(function() {
                googletag.defineSlot('/531683568/go-big-ad/go-big_pc_recrangle', [300, 250], 'div-gpt-ad-1508225834882-0').addService(googletag.pubads());
                googletag.pubads().enableSingleRequest();
                googletag.enableServices();
              });
            </script>
            <div id='div-gpt-ad-1508225834882-0' style='height:250px; width:300px;'>
            <script>
            googletag.cmd.push(function() { googletag.display('div-gpt-ad-1508225834882-0'); });
            </script>
            </div>
            <!-- // /531683568/go-big-ad/go-big_pc_recrangle -->
          </div>
