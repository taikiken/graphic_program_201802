...
$live = array(
  ...
  'endpoint' => UT_ENV !== 'PRODUCTION' ? "'https://dev-img.sportsbull.jp/static/gobig/live.json'" : "'https://img.sportsbull.jp/static/gobig/live.json'"
);
...
<script src="/assets/player/js/vplayer_go-big.js"></script>
