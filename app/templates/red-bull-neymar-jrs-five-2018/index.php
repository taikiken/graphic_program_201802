  ...
  <div id="whole" class="whole dark <?php echo $page['template_classname']; ?>">
    ...
    <div class="body-sec">
      <div class="bg-container">
        <div class="rb--head">
            <img src="/assets/images/red-bull-neymar-jrs-five-2018/ttl_rb.png" alt="" class="rb-hide-pc">
            <img src="/assets/images/red-bull-neymar-jrs-five-2018/ttl_rb_pc.png" alt="" class="rb-hide-sp">
        </div>
        <div class="rb--movie">
          <!--
          <div id="VideoPlayer">
          ...
          -->
          <img src="/assets/images/red-bull-neymar-jrs-five-2018/rb_announce.png" alt="">
        </div>
        ...
        <div class="body-sec-inner">
          <div class="main-sec">
            ...
            <div class="rb-appli">
              ...
              ?>
                ...
                <a href="https://app.adjust.com/tv698b4" target="_blank">
                  <img src="/assets/images/red-bull-neymar-jrs-five-2018/bnr_spbl_app.png" alt="アプリなら無料ライブ配信開始の通知を受け取れる！" class="rb-hide-pc">
                  <img src="/assets/images/red-bull-neymar-jrs-five-2018/bnr_spbl_app_pc.png" alt="アプリなら無料ライブ配信開始の通知を受け取れる！" class="rb-hide-sp">
                </a>
            ...
            <section class="rb--timetable">
              <h2><img src="/assets/images/red-bull-neymar-jrs-five-2018/ttl_timetable.png" alt="">タイムテーブル</h2>
              <table>
                <tbody>
                  <tr>
                    <th>10:00</th>
            ...
            <section class="rb--related">
              <h2><img src="/assets/images/red-bull-neymar-jrs-five-2018/ttl_related.png" alt="">関連記事</h2>
              <ul>
                <li>
