                  ...
                  <div class="form_block">
                    ...
                    <table>
                      <tr>
                        ...
                        <td>
                          <input type="text" id="name1" name="name1" placeholder="姓" class="width01 mr" required>
                          <input type="text" id="name2" name="name2" placeholder="名" class="width01" required>
                        </td>
                      </tr>
                      <tr>
                        <th>
                        ...
                        <td>
                          <input type="text" id="postcode" name="postcode" placeholder="郵便番号" class="width01" onKeyUp="AjaxZip3.zip2addr(this,'','prefectures','city','address');" required>
                          <br>
                          ...
                          <input type="text" id="city" name="city" placeholder="市区町村" class="width01" required>
                          <br>
                      ...
                      <tr>
                        <th>電話番号</th>
                        <td>
                          <input type="text" id="tel" name="tel" class="width02" required>
                        </td>
                      </tr>
                      <tr>
                        <th>メールアドレス</th>
                        <td>
                          <input type="text" id="email" name="email" class="width02" required>
                        </td>
                      </tr>
                      <tr>
                        <th>性　　別</th>
                      ...
                      <tr>
                        <th>コーチ歴</th>
                        <td>
                          <input type="text" id="coach" name="coach" class="width03" required> <span>年</span></td>
                      </tr>
                    </table>
                    <div class="entry_btn">
                  ...
                  <div class="form_block">
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="text" id="postcode" name="postcode" placeholder="郵便番号" required onKeyUp="AjaxZip3.zip2addr(this,'','prefectures2','city2','address2');">
                          <br>
                          <select name="prefectures2" class="width01 mr" required>
                            <option value="" selected>都道府県</option>
                            <option value="1">北海道</option>
                            <option value="2">青森県</option>
                            <option value="3">岩手県</option>
                          ...
                          <input type="text" id="city2" name="city" placeholder="市区町村" class="width01" required>
                          <br>
                          <input type="text" id="address2" name="address" placeholder="番地・ビル名" class="width02" required>
                        </td>
                      </tr>
                      <tr>
                        <th>電話番号</th>
